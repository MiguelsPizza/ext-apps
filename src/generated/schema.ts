 ...
 */
export const McpUiScreenshotRequestSchema = z.object({
  method: z.literal("ui/screenshot"),
  params: z.object({
    ...
    format: z
      ...
      .optional()
      .describe(
        'Format for the screenshot image. Defaults to "png" if not specified.',
      ),
    ...
    quality: z
      ...
      .optional()
      .describe(
        "Quality for lossy formats (jpeg, webp). Value between 0 and 1. Defaults to 0.92 if not specified.",
      ),
  }),
});
 ...
 */
export const McpUiScreenshotResultSchema = z
  .object({
    ...
    width: z.number().describe("Width of the captured image in pixels."),
    /** @description Height of the captured image in pixels. */
    height: z.number().describe("Height of the captured image in pixels."),
    /** @description True if the screenshot capture failed. */
    isError: z
      .boolean()
      .optional()
      .describe("True if the screenshot capture failed."),
  })
  .passthrough();
 ...
 */
export const McpUiClickRequestSchema = z.object({
  method: z.literal("ui/click"),
  params: z.object({
    /** @description X coordinate in pixels, relative to the App's viewport origin. */
    x: z
      .number()
      .describe(
        "X coordinate in pixels, relative to the App's viewport origin.",
      ),
    /** @description Y coordinate in pixels, relative to the App's viewport origin. */
    y: z
      .number()
      .describe(
        "Y coordinate in pixels, relative to the App's viewport origin.",
      ),
    ...
    type: z
      ...
      .optional()
      .describe(
        'Type of click to simulate. Defaults to "click" if not specified.',
      ),
    /** @description Mouse button to simulate. Defaults to "left" if not specified. */
    button: z
      .union([z.literal("left"), z.literal("right"), z.literal("middle")])
      .optional()
      .describe(
        'Mouse button to simulate. Defaults to "left" if not specified.',
      ),
  }),
});
 ...
 */
export const McpUiClickResultSchema = z
  .object({
    /** @description True if the click was successfully dispatched to the target element. */
    success: z
      .boolean()
      .describe(
        "True if the click was successfully dispatched to the target element.",
      ),
    /** @description The element that received the click event, if available. */
    targetElement: z
      .string()
      .optional()
      .describe("The element that received the click event, if available."),
    /** @description True if the click dispatch failed. */
    isError: z
      .boolean()
      .optional()
      .describe("True if the click dispatch failed."),
  })
  .passthrough();
