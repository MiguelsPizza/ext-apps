...
/**
 * @description Discriminated union for type-safe HTTP request body construction.
 * Use these types when you want compile-time enforcement of body/bodyType correlation.
 */
...
/**
 * @description Discriminated union for type-safe HTTP response body handling.
 * Use these types when you want compile-time enforcement of body/bodyType correlation.
 */
...
/**
 * @description Base request fields without body (for use with discriminated union).
 */
...
/**
 * @description Base response fields without body (for use with discriminated union).
 */
...
/**
 * @description Type-safe HTTP request with enforced body/bodyType correlation.
 * Prefer this over McpHttpRequest when constructing requests programmatically.
 */
export type McpHttpRequestStrict = McpHttpRequestBase & McpHttpRequestBody;

/**
 * @description Type-safe HTTP response with enforced body/bodyType correlation.
 * Prefer this over McpHttpResponse when handling responses programmatically.
 */
